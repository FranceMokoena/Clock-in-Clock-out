...
Your app is already configured to use: `https://clock-in-clock-out-oyia.onrender.com/api`
...
```javascript
const DEFAULT_PRODUCTION_URL = 'https://your-actual-render-url.onrender.com/api';
```
...
curl https://your-render-url.onrender.com/api/staff/health

# Or visit in browser
https://your-render-url.onrender.com/api/staff/health
```
