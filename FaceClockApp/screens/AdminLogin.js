    ...
    try {
      ...
      if (response.data && response.data.success) {
        ...
        showProfessionalMessage(
          ...
          response.data?.error || 'Invalid username or password. Please check your credentials and try again.',
          'error'
        );
      }
    } catch (error) {
      ...
      >
        ...
        >
          ...
          <View style={[styles.header, dynamicStyles.header]}>
            ...
            <Text style={[styles.headerTitle, dynamicStyles.headerTitle]}>Administrative Access</Text>
          ...
          <View style={[styles.formContainer, dynamicStyles.formContainer]}>
            <View style={styles.logoContainer}>
              <View style={[styles.logoCircle, dynamicStyles.logoCircle]}>
                <MaterialIcons name="lock" size={42} color="#3166AE" />
              </View>
            </View>
            
            <Text style={[styles.formTitle, dynamicStyles.formTitle]}>Administrative Access</Text>
